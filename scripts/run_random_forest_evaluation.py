"""
Runs Random Forest on REAL USD/JPY data via walk-forward validation,
...
from src.research.random_forest_model import train_and_predict_walk_forward
...
def main():
    ...
    print()
    print("RANDOM FOREST - Real USD/JPY Results (out-of-sample, walk-forward)")
